...
```bash
ue-cli --port 30020 editor status
ue-cli --port 30021 material list
```
...
ue-cli project info --project F:\path\to\MyProject.uproject

# Check editor status
ue-cli editor status

# Material analysis workflow
ue-cli --json material list
ue-cli --json material analyze /Game/MyMaterial
ue-cli --json screenshot static --filename material_check
