...
`ue-cli` is a Python CLI harness for AI agents controlling Unreal Engine 5 editors. It wraps two UE interaction modes:
...
- Task JSON files are stored in `UE_CLI_TASK_DIR` or the system temp directory under `ue_cli_tasks`.
